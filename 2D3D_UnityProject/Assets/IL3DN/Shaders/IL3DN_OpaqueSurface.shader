    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				#ifdef _SNOW_ON
				float staticSwitch15 = ( saturate( step( abs( ( 1.0 - WorldSpaceNormal.y ) ) , 0.75 ) ) * SnowRocksFloat );
				#else
		        ...
		        float3 Albedo = saturate( ( staticSwitch15 + ( _Color * tex2D( _MainTex, uv_MainTex ) ) ) ).rgb;
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN  ) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		#ifdef _SNOW_ON
           		float staticSwitch15 = ( saturate( step( abs( ( 1.0 - ase_worldNormal.y ) ) , 0.75 ) ) * SnowRocksFloat );
           		#else
           		float staticSwitch15 = 0.0;
           		#endif
...
/*ASEBEGIN
Version=17009
395;299;1636;1163;1685.072;979.739;1.653103;True;True
Node;AmplifyShaderEditor.CommentaryNode;9;-1515.102,-662.7073;Inherit;False;1111.809;351.7535;Snow;8;15;14;13;12;10;17;18;19;Snow;1,1,1,1;0;0
Node;AmplifyShaderEditor.WorldNormalVector;10;-1486.222,-614.6884;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.OneMinusNode;17;-1300.105,-568.3484;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;18;-1140.664,-569.7977;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;19;-1009.99,-570.5875;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.75;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1483.917,-435.2356;Inherit;False;Global;SnowRocksFloat;SnowRocksFloat;4;0;Create;True;0;0;False;0;1;0;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;12;-875.0152,-572.0773;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-730.0474,-453.7728;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;15;-602.5934,-576.4561;Inherit;False;Property;_Snow;Snow;2;0;Create;True;0;0;False;0;1;1;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-78.81878,-302.2351;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;20;60.93992,-112.0855;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-248.1013,13.43138;Float;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
WireConnection;4;9;8;0
WireConnection;4;3;8;0
WireConnection;4;4;8;0
ASEEND*/
//CHKSM=20BE1BA0E0D54E8B802FE13D1C5925335361A22B