...
public class PatternCube : MonoBehaviour
{
    ...
    private IEnumerator RaiseCoroutine(bool raise)
    {
        ...
        Vector3 raisePosition = new Vector3(startPosition.x, startPosition.y + selectYOffset, startPosition.y);
        Vector3 initPosition = transform.localPosition;
        Vector3 finalPosition = raise ? raisePosition : startPosition;
